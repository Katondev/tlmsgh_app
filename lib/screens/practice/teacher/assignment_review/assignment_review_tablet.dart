...
class AssignmentReviewTablet extends StatefulWidget {
  final Arguments arguments;
  const AssignmentReviewTablet({super.key, required this.arguments});

  @override
  State<AssignmentReviewTablet> createState() => _AssignmentReviewTabletState();
}

class _AssignmentReviewTabletState extends State<AssignmentReviewTablet> {
