...
class PracticeItemTablet extends StatelessWidget {
  final Assignment? assignment;
  final Function()? onPressed;

  const PracticeItemTablet({Key? key, this.assignment, this.onPressed})
      : super(key: key);
      ...
      child: Row(
        children: [
          Container(
            ...
            margin: all14,
            decoration: BoxDecoration(
                borderRadius: onlyTopLeft50,
                image: DecorationImage(
                    fit: BoxFit.cover,
                    image: CachedNetworkImageProvider(
                        'https://katon.app/static/media/about.92c25f7f41eb8dec6f29.png'))),
          ),
          w50,
          Expanded(
            child: Container(
                ...
                children: [
                  ...
                  Row(children: [
                    ...
                    Text(
                      ...
                      style:
                          FontStyleUtilities.t1(fontColor: AppColors.grey500),
                    ),
                  ]),
                  h12,
                  ...
                  StartAssignmentButton(
                      onPressed: onPressed, assignment: assignment),
                ],
              ),
            ),
          )
