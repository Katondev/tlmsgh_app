...
class SignupTabletPage extends StatefulWidget {
  SignupTabletPage({super.key});

  @override
  State<SignupTabletPage> createState() => _SignupTabletPageState();
}

class _SignupTabletPageState extends State<SignupTabletPage> {
    ...
    return Obx(
      () => Positioned(
        ...
        child: Container(
          ...
          padding: EdgeInsets.only(right: 70, left: 70, top: 20, bottom: 20),
          child: Column(
                                            ...
                                            Expanded(
                                              child: TextFiledWithTitle(
                                                ...
                                                validator: (value) {
                                                  ...
                                                  log(val);
                                                  if (value.isEmpty) {
                                                    return "require_mobilenumber"
                                                        .tr;
                                                  } else if (val.length > 9) {
                                                    return "mobile_no_validate"
                                                        .tr;
                                                  }
                                                  return null;
                                                },
