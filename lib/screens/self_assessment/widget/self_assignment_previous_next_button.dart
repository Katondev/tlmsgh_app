...
class SelfAssignmentPreviousNextButton extends StatelessWidget {
  const SelfAssignmentPreviousNextButton({Key? key}) : super(key: key);
      ...
      builder: (context, value, child) => Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            w10,
            value.index == value.selfAssessMentQueModel!.data!.questionData!.length-1
                ? SizedBox(width: Responsive.isMobile(context) ? 120 : 170)
                : LargeButton(
                    width: Responsive.isMobile(context) ? 120 : 170,
                    height: 50,
