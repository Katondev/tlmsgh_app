...
TeacherProfileModel teacherProfileModelFromJson(String str) =>
    TeacherProfileModel.fromJson(json.decode(str));

String teacherProfileModelToJson(TeacherProfileModel data) =>
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        teacherProfile: Teacher.fromJson(json["teacher"]),
        token: json["token"],
...
class SubCategoryElement {
  ...
  factory SubCategoryElement.fromJson(Map<String, dynamic> json) =>
      SubCategoryElement(
        ...
        categoryTypeName: categoryTypeNameValues.map[json["categoryTypeName"]]!,
  ...
  Map<String, dynamic> toJson() => {
        ...
        "categoryTypeName": categoryTypeNameValues.reverse[categoryTypeName],
